...
No unresolved defect is known after the beta.168 restartability-preflight release work. If final verification discovers a defect, it becomes a current item here or in the active changelog rather than another historical narrative.
