...
- Advance package/runtime identity to `3.0.0-beta.166`. Hosted tool schema generation remains 26 because this simplification does not change any MCP tool name, input schema, visibility, description, or result shape. No publication or live activation is part of this source change.
