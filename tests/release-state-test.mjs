...
assert(
  tagSyncError({ scope: "local", tag: "v1.2.3", head, commit: null })
    === "local tag v1.2.3 is missing; run the applicable explicitly authorized GitHub release command with --owner-confirm before npm publish",
  "missing local tag did not produce the release-order guidance",
);
assert(
  tagSyncError({ scope: "remote", tag: "v1.2.3", head, commit: null })
    === "remote tag v1.2.3 is missing; run the applicable explicitly authorized GitHub release command with --owner-confirm before npm publish",
